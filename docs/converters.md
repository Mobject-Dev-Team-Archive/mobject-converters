...
When the destination type is known you can use the function **Convert_TYPE_TO_TYPE**
...
```body
   number := 123.0;
   result := Convert_LREAL_TO_BYTE(number,destination);  // destination = 123, result = TRUE
   number := 123.5;
   result := Convert_LREAL_TO_BYTE(number,destination);  // destination = no change, result = FALSE
```

When the destination type is unknown, i.e. when used with a function which supports ANY you can use the function **Convert_TYPE_TO_Destination** and the type will be discovered automatically.
...
```body
   number := 123.0;
   result := Convert_LREAL_TO_Destination(number,destination1);  // destination1 = 123, result = TRUE
   result := Convert_LREAL_TO_Destination(number,destination2);  // destination2 = 123, result = TRUE
   result := Convert_LREAL_TO_Destination(number,destination3);  // destination3 = 123.0, result = TRUE
   result := Convert_LREAL_TO_Destination(number,destination4);  // destination4 = '123.0', result = TRUE
```
...
- Convert_Source_To_Destination(in, out)
- Convert_BOOL_TO_Destination(in, out)
- Convert_BYTE_TO_Destination(in, out)
- Convert_DATE_TO_Destination(in, out)
- Convert_DINT_TO_Destination(in, out)
- Convert_DT_TO_Destination(in, out)
- Convert_DWORD_TO_Destination(in, out)
- Convert_INT_TO_Destination(in, out)
- Convert_LINT_TO_Destination(in, out)
- Convert_LREAL_TO_Destination(in, out)
- Convert_LWORD_TO_Destination(in, out)
- Convert_REAL_TO_Destination(in, out)
- Convert_SINT_TO_Destination(in, out)
- Convert_STRING_TO_Destination(in, out)
- Convert_TIME_TO_Destination(in, out)
- Convert_TOD_TO_Destination(in, out)
- Convert_UDINT_TO_Destination(in, out)
- Convert_UINT_TO_Destination(in, out)
- Convert_ULINT_TO_Destination(in, out)
- Convert_USINT_TO_Destination(in, out)
- Convert_WORD_TO_Destination(in, out)
